...
__*This is not a benchmarket experiment. The idea is understand the formats generated by the pipeline__. 
...
## Preprocessed data
For people developing modules, you can use the preprocessed data (R/Python) :  
This is an experimental specificication of how the final mudata should looks. 
This will be adapted to the MuData formating scheme (see document).  
